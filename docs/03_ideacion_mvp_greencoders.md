...
- `core/`: función que lea los datos del formulario de huella de carbono y los ingrese a la base de datos, también una función que administre la generación y registro de las tareas/retos nuevos y ya realizados. Funciones que realizan procesos internos de la app
